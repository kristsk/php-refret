...
PHP_ARG_ENABLE(refret, whether to enable Refret extension, [  --enable-refret   Enable Refret extension])

if test "$PHP_REFRET" != "no"; then

  dnl this defines the extension
  PHP_NEW_EXTENSION(refret, php_refret.c, $ext_shared)
